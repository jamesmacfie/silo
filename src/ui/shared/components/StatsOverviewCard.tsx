...
export function StatsOverviewCard(): JSX.Element {
  ...
  const totalActiveTabs = Object.values(activeTabs).reduce((sum, count) => sum + count, 0);
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-600 dark:text-gray-400">Active Tabs</span>
        ...
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-600 dark:text-gray-400">Active Containers</span>
        ...
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-600 dark:text-gray-400">Total Containers</span>
        ...
        {globalStats && (
          <>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600 dark:text-gray-400">Tabs Opened (All Time)</span>
              <span className="text-lg font-semibold text-gray-900 dark:text-gray-100">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600 dark:text-gray-400">Rules Matched (All Time)</span>
              <span className="text-lg font-semibold text-gray-900 dark:text-gray-100">
